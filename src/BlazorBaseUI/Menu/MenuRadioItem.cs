...
public sealed class MenuRadioItem : ComponentBase, IReferencableComponent
{
    ...
    {
        var state = new MenuRadioItemState(
            Disabled: ResolvedDisabled,
            Highlighted: highlighted,
            Checked: Checked);
        ...
        if (isComponentRenderAs)
        {
            ...
            builder.AddAttribute(2, "role", "menuitemradio");
            builder.AddAttribute(3, "aria-checked", Checked ? "true" : "false");
