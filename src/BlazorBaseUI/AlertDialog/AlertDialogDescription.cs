...
public sealed class AlertDialogDescription : ComponentBase, IReferencableComponent
{
    private DialogDescription? innerComponent;
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        builder.AddComponentReferenceCapture(5, component => innerComponent = (DialogDescription)component);
